...
const thumbs = (ctx) => {
  ...
  return cl.url(`${ctx.public_id}.png`, {
    gravity: 'center', height: 128, quality: 'auto:best', radius: 2, width: 128, crop: 'thumb',
  });
};
...
const background = (ctx) => {
  ...
  return cl.url(ctx.public_id, {
    gravity: 'auto', height: 960, quality: 'auto:best', width: 1280, crop: 'fill',
  });
};
...
const logo = (ctx) => {
  ...
  return cl.url(ctx.public_id, {
    height: 55, quality: 'auto:good', width: 190, crop: 'limit',
  });
};
